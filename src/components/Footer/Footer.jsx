        ...
        <footer>
            ...
            <div className="site-map">
                    <ul>
                        ...
                        <li><Link to='/activities' className='footerlink'>Activities</Link></li>
                        <li ><Link to='/legacies' className='footerlink'>LEGacies</Link></li>
                        <li ><Link to='/membership' className='footerlink'>Membership</Link></li>
            ...
            <div className="contact">
                    ...
                    <ul>
                        <li>
                            ...
                            <a href="https://linkedin.com/in/chidiadi-anyanwu">LinkedIn</a></li>
                        <li>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
                            ...
                            <a href="https://github.com/chidiadi01"> GitHub</a></li>
                    </ul>
            </div>
